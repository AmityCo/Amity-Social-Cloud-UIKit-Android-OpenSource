...
fun LazyListScope.amityUserClipFeedLLS(
    ...
    if (isBlockedByMe) {
            ...
            AmityBaseComponent(
                ...
                Box(modifier = Modifier.height(480.dp)) {
                    AmityBlockedUserFeed(
                        ...
                        feedType = AmityUserFeedType.CLIP,
                    )
                }
            }
        }
        ...
        when (postListState) {
            ...
            PostListState.ERROR -> {
                item {
                    val error = (clipPosts.loadState.mediator?.refresh as? LoadState.Error)
            ...
            PostListState.SUCCESS -> {
                ...
                items(
                    ...
                    key = { "video_${clipPosts[it]?.getPostId() ?: it}" }
                ) { index ->
                    Row(
