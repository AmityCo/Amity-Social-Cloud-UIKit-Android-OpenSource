package com.amity.socialcloud.uikit.community.compose.clip.create.element
...
fun AmityClipCameraShutterButtonElement(
    ...
    isImageCaptureMode: Boolean = false,
...
@Composable
private fun AmityClipCameraShutterButtonElementPreview() {
