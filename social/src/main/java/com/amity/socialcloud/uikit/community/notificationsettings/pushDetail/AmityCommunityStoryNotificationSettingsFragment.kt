...
class AmityCommunityStoryNotificationSettingsFragment :
    ...
    class Builder internal constructor() {
        ...
        fun build(): AmityCommunityStoryNotificationSettingsFragment {
            return AmityCommunityStoryNotificationSettingsFragment().apply {
                arguments =
                    Bundle().apply {
