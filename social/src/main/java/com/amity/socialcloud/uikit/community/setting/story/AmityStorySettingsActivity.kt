...
import com.amity.socialcloud.uikit.community.databinding.AmityActivityStorySettingsBinding

class AmityStorySettingsActivity :
    AmityBaseActivity<AmityActivityStorySettingsBinding, AmityStorySettingsViewModel>(),
    ...
    companion object {
        ...
        fun newIntent(context: Context, communityId: String): Intent =
            Intent(context, AmityStorySettingsActivity::class.java).apply {
    ...
    private fun setUpToolbar() {
        getViewDataBinding().toolbar.setLeftDrawable(
    ...
    private fun loadFragment() {
        ...
        var fragment: AmityStorySettingsFragment? = null

        intent.getStringExtra(COMMUNITY_ID)?.let { communityId ->
            fragment = AmityStorySettingsFragment.newInstance(communityId).build(this)
        }
    ...
    override fun getLayoutId(): Int = R.layout.amity_activity_story_settings

    override fun getViewModel(): AmityStorySettingsViewModel =
        ViewModelProvider(this).get(AmityStorySettingsViewModel::class.java)
