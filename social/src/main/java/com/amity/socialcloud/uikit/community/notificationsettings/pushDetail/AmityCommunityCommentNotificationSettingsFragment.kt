...
class AmityCommunityCommentNotificationSettingsFragment :
    ...
    class Builder internal constructor() {
        ...
        fun build(): AmityCommunityCommentNotificationSettingsFragment {
            return AmityCommunityCommentNotificationSettingsFragment().apply {
                arguments =
                    Bundle().apply {
