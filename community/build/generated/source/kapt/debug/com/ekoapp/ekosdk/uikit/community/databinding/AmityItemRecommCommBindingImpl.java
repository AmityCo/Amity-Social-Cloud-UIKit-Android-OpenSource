...
public class AmityItemRecommCommBindingImpl extends AmityItemRecommCommBinding implements com.ekoapp.ekosdk.uikit.community.generated.callback.OnClickListener.Listener {
    ...
    public AmityItemRecommCommBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private AmityItemRecommCommBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback11 = new com.ekoapp.ekosdk.uikit.community.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x5L) != 0) {
                ...
                if (ekoCommunity != null) {
                    ...
                    // read ekoCommunity.description
                    ekoCommunityDescription = ekoCommunity.getDescription();
                }


                if (ekoCommunityAvatar != null) {
                    // read ekoCommunity.avatar.url
                    ekoCommunityAvatarUrl = ekoCommunityAvatar.getUrl();
                }
        }
        // batch finished
        if ((dirtyFlags & 0x5L) != 0) {
            ...
            com.ekoapp.ekosdk.uikit.components.BindingUtilityKt.setImageUrl(this.ivAvatar, ekoCommunityAvatarUrl, androidx.appcompat.content.res.AppCompatResources.getDrawable(ivAvatar.getContext(), R.drawable.amity_ic_default_community_avatar_small));
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.mboundView4, ekoCommunityDescription);
