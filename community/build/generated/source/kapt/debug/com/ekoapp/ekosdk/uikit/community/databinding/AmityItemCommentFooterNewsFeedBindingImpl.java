...
public class AmityItemCommentFooterNewsFeedBindingImpl extends AmityItemCommentFooterNewsFeedBinding  {
    ...
    public AmityItemCommentFooterNewsFeedBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View[] root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private AmityItemCommentFooterNewsFeedBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View[] root, Object[] bindings) {
        super(bindingComponent, root[0], 0
            , (android.widget.ImageButton) bindings[2]
            , (com.google.android.material.checkbox.MaterialCheckBox) bindings[0]
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x1L) != 0) {
            ...
            this.reply.setTextColor(getColorFromResource(reply, R.color.amityColorBase));
