...
class AmityGroupNotificationPreferencePageActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        fun newIntent(context: Context, channelId: String): Intent {
            return Intent(context, AmityGroupNotificationPreferencePageActivity::class.java).apply {
